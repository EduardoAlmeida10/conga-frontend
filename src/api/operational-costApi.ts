 ...
 */
export async function findOperationalCostById(id: string): Promise<OperationalCost> {
 ...
 */
export async function deleteOperationalCost(id: string): Promise<{ message: string }> {
