  ...
  return (
    <div className="flex h-screen justify-center items-center ">
      <div className="flex flex-col items-center justify-center w-1/2">
        ...
        >
          <input type="text" name="username" placeholder="nome" className="bg-white p-2 rounded border border-gray-300"/>
          <input type="password" name="password" placeholder="senha" className="bg-white p-2 rounded border border-gray-300"/>
          <Button>
            <p>Login</p>
          </Button>
        </form>
